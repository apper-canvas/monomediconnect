        ...
        <div className="container mx-auto px-4 flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-6">
              <li>
                <Link to="/dashboard" className="flex items-center gap-1.5 px-2 py-1 text-sm font-medium transition-colors text-primary">
                  <HomeIcon size={16} />
                  Dashboard
                </Link>
              </li>
        ...
        >
          <div className="mb-8">
            ...
            <p className="mt-2 text-surface-600 dark:text-surface-400">
              Welcome to your MediConnect dashboard. Manage your healthcare appointments and services.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <h2 className="mb-2 text-xl font-semibold">Your Appointments</h2>
            ...
            >
              ...
              <p className="mb-4 text-surface-600 dark:text-surface-400">
                Explore the healthcare services available at MediConnect.
              </p>
              <Link
                to="/services"
                className="inline-flex items-center text-primary hover:text-primary-dark"
            ...
            >
              ...
              <h2 className="mb-2 text-xl font-semibold">Visit Homepage</h2>
              <p className="mb-4 text-surface-600 dark:text-surface-400">
                Return to the public MediConnect website homepage.
              </p>
              <Link
                to="/"
                className="inline-flex items-center text-primary hover:text-primary-dark"
